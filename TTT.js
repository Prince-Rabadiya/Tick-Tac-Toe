...
function TTT() {
    while (loop == 0 && x <= 5) {
        ...
        if (loop == 0) {
            ...
            console.log(array[1] + " | " + array[2] + " | " + array[3] + "            enter 'play again' for replay");
            console.log(array[4] + " | " + array[5] + " | " + array[6] + "            enter 'terminate' for quit");
...
function getUserInput() {
    ...
    try {
        ...
        if (loop == 0) {
            ...
            if (array[user_turn] !== " ") {
                alert("This place already have value : " + array[user_turn]);
                getUserInput();
            }
            else {
                array[user_turn] = 0;
...
function terminate() {
    var y = confirm("do you really want to quit ?????");
    if (y == 1) {
        loop = 1;
    }
    else {
